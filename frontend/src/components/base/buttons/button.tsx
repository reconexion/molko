...
export const styles = sortCx({
    ...
    colors: {
        ...
        // Positive / affirmative actions (export, generate, download, confirm).
        success: {
            root: [
                "bg-success-solid text-white shadow-xs-skeuomorphic ring-1 ring-transparent ring-inset hover:bg-green-700 data-loading:bg-green-700",
                "before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0%",
                "*:data-icon:text-white/60 hover:*:data-icon:text-white/70",
            ].join(" "),
        },
